      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-12 lg:gap-16">
            {[
              { name: "Studio Room", price: "₦30,000", image: "/images/rooms/studio.jpg", size: "25 SQM" },
              { name: "Standard Room", price: "₦70,000", image: "/images/rooms/standard.jpg", size: "30 SQM" },
              { name: "Deluxe Suite", price: "₦80,000", image: "/images/rooms/deluxe.jpg", size: "40 SQM", featured: true },
              { name: "Premium Room", price: "₦90,000", image: "/images/rooms/premium.jpg", size: "45 SQM" },
              { name: "Mini Suite", price: "₦100,000", image: "/images/rooms/mini.jpg", size: "50 SQM" },
              { name: "Royal Suite", price: "₦150,000", image: "/images/rooms/royal.jpg", size: "65 SQM", featured: true },
              { name: "Royal Classic", price: "₦200,000", image: "/images/rooms/royal-classic.jpg", size: "70 SQM" },
              { name: "Executive Apt", price: "₦200,000", image: "/images/rooms/executive.jpg", size: "120 SQM" },
              { name: "Presidential", price: "₦300,000", image: "/images/rooms/presidential.jpg", size: "250 SQM", featured: true },
            ].map((room, index) => (
              <div
                key={index}
                className={cn(
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input id="name" placeholder="John Doe" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} required className="rounded-xl border-secondary/20 h-12" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-[10px] uppercase tracking-widest font-bold text-muted-foreground">Email Address *</Label>
                    <Input id="email" type="email" placeholder="john@example.com" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} required className="rounded-xl border-secondary/20 h-12" />
                  </div>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="subject" className="text-[10px] uppercase tracking-widest font-bold text-muted-foreground">Subject *</Label>
                  <Input id="subject" placeholder="How can we assist you?" value={formData.subject} onChange={(e) => setFormData({ ...formData, subject: e.target.value })} required className="rounded-xl border-secondary/20 h-12" />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="message" className="text-[10px] uppercase tracking-widest font-bold text-muted-foreground">Message *</Label>
                  <Textarea id="message" placeholder="Describe your request..." value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} required rows={5} className="rounded-xl border-secondary/20 resize-none" />
                </div>
